...
export const publicPageContent = {
  ...
  gallery: {
    metadata: {
      ...
      description:
        "Browse mock portfolio studies for brand sessions, content days, and creative planning work.",
    },
    eyebrow: "Gallery",
  ...
  contact: {
    metadata: {
      ...
      description:
        "Contact Atelier Bookings or start an internal booking inquiry for creative studio services.",
    },
    hero: {
      eyebrow: "Contact",
